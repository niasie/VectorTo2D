...
public class Coordinatesystem extends JPanel {
	...
	public Coordinatesystem() {
		...
		// lines.add(new Line(new Vector3Di(0, 0, 0), new Vector3Di(10000, 10000, 10000)));
	...
	public void paintComponent(Graphics g) {
		...
		for (Line l: lines) {
			...
			// if (v2.getX2() - v1.getX2())
			
			double s1, s2;
			Vector3Di u1, u2;
			
			if (Double.isFinite((double) -v1.getX2() / direction.getX2())) {
				s1 = (double) -v1.getX2() / direction.getX2();
				s2 = (double) (getWidth() - v1.getX2()) / direction.getX2();
				
				u1 = new Vector3Di(v1.getX1() + (int) (s1 * direction.getX1()), 0, v1.getX3() + (int) (s1 * direction.getX3()));
				u2 = new Vector3Di(v1.getX1() + (int) (s2 * direction.getX1()), getWidth(), v1.getX3() + (int) (s2 * direction.getX3()));
			} else {
				s1 = (double) -v1.getX3();
				s2 = (double) (getHeight() - v1.getX3());
				
				u1 = new Vector3Di(v1.getX1() + (int) (s1 * direction.getX1()), getWidth() / 2, 0);
				u2 = new Vector3Di(v1.getX1() + (int) (s2 * direction.getX1()), getWidth() / 2, getHeight());
			}
			
			System.out.println(v1.toString() + " " + direction.toString() + " " + s1 + " " + s2 + "   " + u1.toString() + " " + u2.toString());
